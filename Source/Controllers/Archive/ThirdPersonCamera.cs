...
namespace Controllers
{
    public class ThirdPersonCamera : MonoBehaviour
    {
        ...
        public PlayerControllerOld.ControllerPOV UpdateCameraForScrollwheel(PlayerControllerOld.ControllerPOV controllerPOV, GameObject corpse)
        {
            PlayerControllerOld.ControllerPOV testControllerPOV = controllerPOV;
            Vector3 adjustedPosition = target.localPosition;

            var delta = Input.GetAxis("Mouse ScrollWheel");
            if (delta < 0)
            {
                if (testControllerPOV == PlayerControllerOld.ControllerPOV.First)
                {
                    testControllerPOV = PlayerControllerOld.ControllerPOV.Third;
                    distance = 1f;
            ...
            if (corpse != null && testControllerPOV == PlayerControllerOld.ControllerPOV.Third)
